...
<div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title"><i class="fa fa-book"></i> Jurusan</h3>
      <div class="pull-right box-tools">
        <a href="/superadmin/data/jurusan/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
      </div>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
        ...
        <tbody>
          @foreach ($data as $key=>$item)
              <tr>
                ...
                <a href="/superadmin/data/jurusan/edit/{{$item->id}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
...
<div class="modal fade" id="modal-hapus">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form method="post" action="/superadmin/data/jurusan/delete">
