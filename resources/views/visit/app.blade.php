...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/visit/lib/animate/animate.min.css"/>
        <link href="/visit/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
        <link href="/visit/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">


        <!-- Customized Bootstrap Stylesheet -->
        <link href="/visit/css/bootstrap.min.css" rel="stylesheet">
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light"> 
                    <a href="#" class="navbar-brand p-0">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><img src="/icon/stmik.png" style="padding-bottom: 0px"></td>
                                <td><h1 class="text-primary mb-0"> STMIK IB</h1></td>
                            </tr>
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-0 mx-lg-auto">
                            ...
                            <div class="nav-btn px-3">
                                <a href="#" class="btn btn-primary rounded-pill py-2 px-4 ms-3 flex-shrink-0"> DAFTAR PMB</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="header-carousel owl-carousel">
            <div class="header-carousel-item bg-primary" style="background-image: url('https://dinus.ac.id/wp-content/uploads/2024/06/2024-web-06-13-01-scaled.jpg'); background-size:100% 100%;">
        ...
        <script src="/visit/lib/wow/wow.min.js"></script>
        <script src="/visit/lib/easing/easing.min.js"></script>
        <script src="/visit/lib/waypoints/waypoints.min.js"></script>
        <script src="/visit/lib/counterup/counterup.min.js"></script>
        <script src="/visit/lib/lightbox/js/lightbox.min.js"></script>
        <script src="/visit/lib/owlcarousel/owl.carousel.min.js"></script>
