...
<head>
  ...
  <link rel="stylesheet" href="/stmik/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  ...
  {{-- <link rel="stylesheet" href="/stmik/dist/css/skins/skin-blue.min.css"> --}}
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="/superadmin/beranda" class="logo" style="background-color:#1560BD">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>S</b>IB</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>STMIK-IB</b></span>
    </a>

    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top" role="navigation" style="background-color:#1560BD">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="/stmik/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="/stmik/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">

                <p>
                    {{Auth::user()->username}}
                  <small>STMIK IB</small>
                </p>
              </li>
              <!-- Menu Body -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2024 <a href="#">STMIK IB</a>.</strong> All rights reserved.
  </footer>
